! function(e, t) {
    ...
    function u(e, t = m.Dxa) {
        if (null == e || /.+(p[xt]|[%])$/.test(e)) return e;
        var r = parseInt(e) * t.mul;
        return t.min && t.max && (r = function(e, t, r) {
            return t > e ? t : r < e ? r : e
        }(r, t.min, t.max)), `${r.toFixed(2)}${t.unit}`
    }

    function p(e, t, r) {
        if (e.namespaceURI != h.wordml) return !1;
        switch (e.localName) {
            case "color":
                t.color = r.attr(e, "val");
                break;
            case "sz":
                t.fontSize = r.lengthAttr(e, "val", m.FontSize);
                break;
            default:
                return !1
        }
    ...
    class d {
        ...
        lengthAttr(e, t, r = m.Dxa) {
            return u(this.attr(e, t), r)
        }
    }
    const f = new d;
    class g {
    ...
    function y(e, t) {
        return t.elements(e).map((e => function(e, t) {
            let r = {
                name: t.attr(e, "name"),
                embedFontRefs: []
            };
    ...
    class v extends g {
        parseXml(e) {
            this.fonts = y(e, this._package.xmlParser)
        }
    }
    class S {
        constructor(e, t) {
            this._zip = e, this.options = t, this.xmlParser = new d
        }
        get(e) {
            const t = function(e) {
        ...
        async loadRelationships(e = null) {
            ...
            return r ? (a = this.parseXmlDocument(r).firstElementChild, (n = this.xmlParser).elements(a).map((e => ({
                id: n.attr(e, "Id"),
                type: n.attr(e, "Type"),
                target: n.attr(e, "Target"),
                targetMode: n.attr(e, "TargetMode")
            })))) : null;
            var a, n
        }
        parseXmlDocument(e) {
    ...
    function w(e, t) {
        return {
            ...
            size: t.lengthAttr(e, "sz", m.Border),
            offset: t.lengthAttr(e, "space", m.Point),
    ...
    function B(e, t) {
        let r = {};
        for (let a of t.elements(e)) $(a, r, t);
        return r
    }
    ...
    class j extends V {
        constructor() {
            super(...arguments), this.type = N.Header
        }
    }
    class W extends V {
        constructor() {
            super(...arguments), this.type = N.Footer
        }
    }
    class X extends g {
        constructor(e, t, r) {
    ...
    class te extends g {
        ...
        parseXml(e) {
            this.theme = function(e, t) {
                ...
                for (let e of t.elements(a)) switch (e.localName) {
                    case "clrScheme":
                        r.colorScheme = Y(e, t);
                        break;
                    case "fontScheme":
    ...
    class ae extends re {
        constructor() {
            super(...arguments), this.type = N.Footnote
        }
    }
    class se extends re {
        constructor() {
            super(...arguments), this.type = N.Endnote
        }
    }
    class ne extends g {
        constructor(e, t, r) {
    ...
    class le extends ne {
        ...
        parseXml(e) {
            this.notes = this._documentParser.parseNotes(e, "footnote", ae)
        }
    }
    class oe extends ne {
        constructor(e, t, r) {
        ...
        parseXml(e) {
            this.notes = this._documentParser.parseNotes(e, "endnote", se)
        }
    }
            ...
            this.settings = function(e, t) {
                ...
                for (let a of t.elements(e)) switch (a.localName) {
                    case "defaultTabStop":
                        ...
                        break;
                    case "footnotePr":
                        r.footnoteProps = ie(a, t);
                        break;
                    case "endnotePr":
                        r.endnoteProps = ie(a, t);
                        break;
    ...
    class ue extends g {
        ...
        parseXml(e) {
            ...
            for (let r of t.elements(e, "commentEx")) this.comments.push({
    ...
    class de {
        ...
        static async load(e, t, r) {
            var a = new de;
            return a._options = r, a._parser = t, a._package = await S.load(e, r), a.rels = await a._package.loadRelationships(), await Promise.all(pe.map((e => {
        ...
        async loadRelationshipPart(e, t) {
            ...
            switch (t) {
                case r.OfficeDocument:
                    this.documentPart = a = new P(this._package, e, this._parser);
                    break;
                case r.FontTable:
                    this.fontTablePart = a = new v(this._package, e);
                    break;
                case r.Numbering:
                    this.numberingPart = a = new _(this._package, e, this._parser);
                    break;
                case r.Styles:
                    this.stylesPart = a = new z(this._package, e, this._parser);
                    break;
                case r.Theme:
                    this.themePart = a = new te(this._package, e);
                    break;
                case r.Footnotes:
                    this.footnotesPart = a = new le(this._package, e, this._parser);
                    break;
                case r.Endnotes:
                    this.endnotesPart = a = new oe(this._package, e, this._parser);
                    break;
                case r.Footer:
                    a = new U(this._package, e, this._parser);
                    break;
                case r.Header:
                    a = new G(this._package, e, this._parser);
                    break;
                case r.CoreProperties:
                    this.corePropsPart = a = new Z(this._package, e);
                    break;
                case r.ExtendedProperties:
                    this.extendedPropsPart = a = new J(this._package, e);
                    break;
                case r.CustomProperties:
                    a = new he(this._package, e);
                    break;
                case r.Settings:
                    this.settingsPart = a = new ce(this._package, e);
                    break;
                case r.Comments:
                    this.commentsPart = a = new me(this._package, e, this._parser);
                    break;
                case r.CommentsExtended:
                    this.commentsExtendedPart = a = new ue(this._package, e)
            }
            if (null == a) return Promise.resolve(null);
            if (this.partsMap[e] = a, this.parts.push(a), await a.load(), a.rels?.length > 0) {
                const [e] = s(a.path);
                await Promise.all(a.rels.map((t => this.loadRelationshipPart(n(t.target, e), t.type))))
            }
            return a
        }
        ...
        async loadFont(e, t) {
            ...
            return r ? this.blobToURL(new Blob([fe(r, t)])) : r
        }
        ...
        findPartByRelId(e, t = null) {
            ...
            const a = t ? s(t.path)[0] : "";
            return r ? this.partsMap[n(r.target, a)] : null
        }
        getPathById(e, t) {
            const r = e.rels.find((e => e.id == t)),
                [a] = s(e.path);
            return r ? n(r.target, a) : null
        }
        loadResource(e, t, r) {
    ...
    class be extends V {
        constructor() {
            super(...arguments), this.type = N.VmlElement, this.attrs = {}
        }
    }
    ...
    function ye(e, t) {
        ...
        for (const t of f.attrs(e)) switch (t.localName) {
            case "style":
            ...
            case "from":
                ...
                break;
            case "to":
                const [s, n] = ve(t.value);
                Object.assign(r.attrs, {
                    x2: s,
                    y2: n
                })
        }
        for (const a of f.elements(e)) switch (a.localName) {
            case "stroke":
                Object.assign(r.attrs, ke(a));
                break;
            case "fill":
                Object.assign(r.attrs, {});
                break;
    ...
    function ke(e) {
        return {
            ...
            "stroke-width": f.lengthAttr(e, "weight", m.Emu) ?? "1px"
        }
    }
    ...
    class Pe extends V {
        constructor(e) {
            super(), this.id = e, this.type = N.CommentReference
        }
    }
    class we extends V {
        constructor(e) {
            super(), this.id = e, this.type = N.CommentRangeStart
        }
    }
    class Ce extends V {
        constructor(e) {
            super(), this.id = e, this.type = N.CommentRangeEnd
        }
    }
    var xe = "inherit",
        Ne = "black",
    ...
    const Ae = [],
        Te = {
            oMath: N.MmlMath,
            oMathPara: N.MmlMathParagraph,
            f: N.MmlFraction,
            func: N.MmlFunction,
            fName: N.MmlFunctionName,
            num: N.MmlNumerator,
            den: N.MmlDenominator,
            rad: N.MmlRadical,
            deg: N.MmlDegree,
            e: N.MmlBase,
            sSup: N.MmlSuperscript,
            sSub: N.MmlSubscript,
            sPre: N.MmlPreSubSuper,
            sup: N.MmlSuperArgument,
            sub: N.MmlSubArgument,
            d: N.MmlDelimiter,
            nary: N.MmlNary,
            eqArr: N.MmlEquationArray,
            lim: N.MmlLimit,
            limLow: N.MmlLimitLower,
            m: N.MmlMatrix,
            mr: N.MmlMatrixRow,
            box: N.MmlBox,
            bar: N.MmlBar,
            groupChr: N.MmlGroupChar
        };
    class Re {
        constructor(e) {
            this.options = {
        ...
        parseNotes(e, t, r) {
            var a = [];
            for (let s of f.elements(e, t)) {
                const e = new r;
                e.id = f.attr(s, "id"), e.noteType = f.attr(s, "type"), e.children = this.parseBodyElements(s), a.push(e)
            }
            return a
        }
        parseComments(e) {
            var t = [];
            for (let r of f.elements(e, "comment")) {
                const e = new Se;
                e.id = f.attr(r, "id"), e.author = f.attr(r, "author"), e.initials = f.attr(r, "initials"), e.date = f.attr(r, "date"), e.children = this.parseBodyElements(r), t.push(e)
            }
            return t
        }
        parseDocumentFile(e) {
            var t = f.element(e, "body"),
                r = f.element(e, "background"),
                a = f.element(t, "sectPr");
            return {
                type: N.Document,
        ...
        parseStyle(e) {
            ...
            return Be.foreach(e, (e => {
                switch (e.localName) {
                    case "basedOn":
                        t.basedOn = f.attr(e, "val");
                        break;
                    case "name":
                        t.name = f.attr(e, "val");
                        break;
                    case "link":
                        t.linked = f.attr(e, "val");
                        break;
                    case "next":
                        t.next = f.attr(e, "val");
                        break;
                    case "aliases":
                        t.aliases = f.attr(e, "val").split(",");
                        break;
                    case "pPr":
                        t.styles.push({
                            target: "p",
                            values: this.parseDefaultProperties(e, {})
                        }), t.paragraphProps = B(e, f);
                        break;
                    case "rPr":
                        t.styles.push({
                            target: "span",
            ...
            return Be.foreach(e, (e => {
                switch (e.localName) {
                    ...
                    case "numPicBullet":
                        ...
                        break;
                    case "num":
                        var s = f.attr(e, "numId"),
                            n = f.elementAttr(e, "abstractNumId", "val");
                        r[n] = s
                }
            })), t.forEach((e => e.id = r[e.id])), t
        }
        parseNumberingPicBullet(e) {
            var t = f.element(e, "pict"),
                r = t && f.element(t, "shape"),
                a = r && f.element(r, "imagedata");
            return a ? {
                id: f.intAttr(e, "numPicBulletId"),
                src: f.attr(a, "id"),
                style: f.attr(r, "style")
            } : null
        }
        parseAbstractNumbering(e, t) {
            var r = [],
                a = f.attr(e, "abstractNumId");
            return Be.foreach(e, (e => {
        ...
        parseNumberingLevel(e, t, r) {
            ...
            return Be.foreach(t, (e => {
                switch (e.localName) {
                    case "start":
                        a.start = f.intAttr(e, "val");
                        break;
                    case "pPr":
                    ...
                    case "rPr":
                        ...
                        break;
                    case "lvlPicBulletId":
                        var t = f.intAttr(e, "val");
                        a.bullet = r.find((e => e?.id == t));
                        break;
                    case "lvlText":
                        a.levelText = f.attr(e, "val");
                        break;
                    case "pStyle":
                        a.pStyleName = f.attr(e, "val");
                        break;
                    case "numFmt":
                        a.format = f.attr(e, "val");
                        break;
                    case "suff":
                        a.suff = f.attr(e, "val")
                }
        ...
        parseSdt(e, t) {
            const r = f.element(e, "sdtContent");
            return r ? t(r) : []
        }
        parseInserted(e, t) {
            return {
        ...
        parseParagraph(e) {
            ...
            for (let s of f.elements(e)) switch (s.localName) {
                case "pPr":
                ...
                case "bookmarkStart":
                    ...
                    break;
                case "bookmarkEnd":
                    a.children.push(ge(s, f));
                    break;
                case "commentRangeStart":
                    a.children.push(new we(f.attr(s, "id")));
                    break;
                case "commentRangeEnd":
                    a.children.push(new Ce(f.attr(s, "id")));
                    break;
                case "oMath":
                case "oMathPara":
            ...
            this.parseDefaultProperties(e, t.cssStyle = {}, null, (e => {
                ...
                switch (e.localName) {
                    case "pStyle":
                        ...
                        break;
                    case "cnfStyle":
                        t.className = $e.classNameOfCnfStyle(e);
                        break;
                    case "framePr":
                        this.parseFrame(e, t);
                        break;
        ...
        parseFrame(e, t) {
            "drop" == f.attr(e, "dropCap") && (t.cssStyle.float = "left")
        }
        parseHyperlink(e, t) {
            var r = {
                type: N.Hyperlink,
            ...
            return r.anchor = f.attr(e, "anchor"), r.id = f.attr(e, "id"), Be.foreach(e, (e => {
        ...
        parseSmartTag(e, t) {
            var r = {
                ...
                a = f.attr(e, "uri"),
                s = f.attr(e, "element");
            return a && (r.uri = a), s && (r.element = s), Be.foreach(e, (e => {
                if ("r" === e.localName) r.children.push(this.parseRun(e, r))
            })), r
        }
        parseRun(e, t) {
            ...
            return Be.foreach(e, (e => {
                switch ((e = this.checkAlternateContent(e)).localName) {
                    ...
                    case "commentReference":
                        r.children.push(new Pe(f.attr(e, "id")));
                        break;
                    case "fldSimple":
                        r.children.push({
                            type: N.SimpleField,
                            instruction: f.attr(e, "instr"),
                            lock: f.boolAttr(e, "lock", !1),
                            dirty: f.boolAttr(e, "dirty", !1)
                        });
                        break;
                    case "instrText":
                    ...
                    case "noBreakHyphen":
                        r.children.push({
                            type: N.NoBreakHyphen
                        });
                        break;
                    case "br":
                        r.children.push({
                            type: N.Break,
                            break: f.attr(e, "type") || "textWrapping"
                        });
                        break;
                    ...
                    case "footnoteReference":
                        r.children.push({
                            type: N.FootnoteReference,
                            id: f.attr(e, "id")
                        });
                        break;
                    case "endnoteReference":
                        r.children.push({
                            type: N.EndnoteReference,
                            id: f.attr(e, "id")
                        });
                        break;
                    case "drawing":
        ...
        parseMathProperies(e) {
            const t = {};
            for (const r of f.elements(e)) switch (r.localName) {
                case "chr":
                    t.char = f.attr(r, "val");
                    break;
                case "vertJc":
                    t.verticalJustification = f.attr(r, "val");
                    break;
                case "pos":
                    t.position = f.attr(r, "val");
                    break;
                case "degHide":
                    t.hideDegree = f.boolAttr(r, "val");
                    break;
                case "begChr":
                    t.beginChar = f.attr(r, "val");
                    break;
                case "endChr":
                    t.endChar = f.attr(r, "val")
            }
            return t
        }
            ...
            this.parseDefaultProperties(e, t.cssStyle = {}, null, (e => {
                switch (e.localName) {
                    case "rStyle":
                        ...
                        break;
                    case "vertAlign":
                        t.verticalAlign = $e.valueOfVertAlign(e, !0);
                        break;
                    default:
                        return !1
                }
        ...
        checkAlternateContent(e) {
            ...
            var t = f.element(e, "Choice");
            if (t) {
                var r = f.attr(t, "Requires"),
                    a = e.lookupNamespaceURI(r);
                if (Ae.includes(a)) return t.firstElementChild
            }
            return f.element(e, "Fallback")?.firstElementChild
        }
        parseDrawing(e) {
        ...
        parseDrawingWrapper(e) {
            ...
            for (var o of f.elements(e)) switch (o.localName) {
                case "simplePos":
                    s && (n.offset = f.lengthAttr(o, "x", m.Emu), l.offset = f.lengthAttr(o, "y", m.Emu));
                    break;
                case "extent":
                    t.cssStyle.width = f.lengthAttr(o, "cx", m.Emu), t.cssStyle.height = f.lengthAttr(o, "cy", m.Emu);
                    break;
                case "positionH":
                case "positionV":
                    if (!s) {
                        let e = "positionH" == o.localName ? n : l;
                        var i = f.element(o, "align"),
                            c = f.element(o, "posOffset");
                        e.relative = f.attr(o, "relativeFrom") ?? e.relative, i && (e.align = i.textContent), c && (e.offset = Be.sizeValue(c, m.Emu))
                    }
                    break;
            ...
            return "wrapTopAndBottom" == a ? (t.cssStyle.display = "block", n.align && (t.cssStyle["text-align"] = n.align, t.cssStyle.width = "100%")) : "wrapNone" == a ? (t.cssStyle.display = "block", t.cssStyle.position = "relative", t.cssStyle.width = "0px", t.cssStyle.height = "0px", n.offset && (t.cssStyle.left = n.offset), l.offset && (t.cssStyle.top = l.offset)) : !r || "left" != n.align && "right" != n.align || (t.cssStyle.float = n.align), t
        }
        parseGraphic(e) {
            var t = f.element(e, "graphicData");
            for (let e of f.elements(t))
        ...
        parsePicture(e) {
            var t = {
                ...
                r = f.element(e, "blipFill"),
                a = f.element(r, "blip");
            t.src = f.attr(a, "embed");
            var s = f.element(e, "spPr"),
                n = f.element(s, "xfrm");
            for (var l of (t.cssStyle.position = "relative", f.elements(n))) switch (l.localName) {
                case "ext":
                    t.cssStyle.width = f.lengthAttr(l, "cx", m.Emu), t.cssStyle.height = f.lengthAttr(l, "cy", m.Emu);
                    break;
                case "off":
                    t.cssStyle.left = f.lengthAttr(l, "x", m.Emu), t.cssStyle.top = f.lengthAttr(l, "y", m.Emu)
            }
            return t
        }
        parseTable(e) {
            ...
            switch (t.cssStyle = {}, t.cellStyle = {}, this.parseDefaultProperties(e, t.cssStyle, t.cellStyle, (e => {
                    switch (e.localName) {
                        case "tblStyle":
                            ...
                            break;
                        case "tblLook":
                            t.className = $e.classNameOftblLook(e);
                            break;
                        case "tblpPr":
        ...
        parseTablePosition(e, t) {
            var r = f.lengthAttr(e, "topFromText"),
                a = f.lengthAttr(e, "bottomFromText"),
                s = f.lengthAttr(e, "rightFromText"),
                n = f.lengthAttr(e, "leftFromText");
            t.cssStyle.float = "left", t.cssStyle["margin-bottom"] = $e.addSize(t.cssStyle["margin-bottom"], a), t.cssStyle["margin-left"] = $e.addSize(t.cssStyle["margin-left"], n), t.cssStyle["margin-right"] = $e.addSize(t.cssStyle["margin-right"], s), t.cssStyle["margin-top"] = $e.addSize(t.cssStyle["margin-top"], r)
        }
        parseTableRow(e) {
            var t = {
                type: N.Row,
            ...
            t.cssStyle = this.parseDefaultProperties(e, {}, null, (e => {
                switch (e.localName) {
                    case "gridSpan":
                        ...
                        break;
                    case "vMerge":
                        t.verticalMerge = f.attr(e, "val") ?? "continue";
                        break;
                    case "cnfStyle":
                        t.className = $e.classNameOfCnfStyle(e);
                        break;
        ...
        parseTableCellVerticalText(e, t) {
            ...
            Be.foreach(e, (e => {
                if ("textDirection" === e.localName) {
                    const a = f.attr(e, "val"),
                        s = r[a] || {
                            writingMode: "horizontal-tb"
                        };
                    t.cssStyle["writing-mode"] = s.writingMode, t.cssStyle.transform = s.transform
                }
            }))
        }
        parseDefaultProperties(e, t = null, r = null, a = null) {
            return t = t || {}, Be.foreach(e, (s => {
                if (!a?.(s)) switch (s.localName) {
                    case "jc":
                        t["text-align"] = $e.valueOfJc(s);
                        break;
                    case "textAlignment":
                        t["vertical-align"] = $e.valueOfTextAlignment(s);
                        break;
                    case "color":
                        t.color = Be.colorAttr(s, "val", null, Ne);
                        break;
                    case "sz":
                        t["font-size"] = t["min-height"] = f.lengthAttr(s, "val", m.FontSize);
                        break;
                    case "shd":
                        t["background-color"] = Be.colorAttr(s, "fill", null, xe);
                        break;
                    case "highlight":
                        t["background-color"] = Be.colorAttr(s, "val", null, Ee);
                        break;
                    case "vertAlign":
                        break;
                    case "position":
                        t.verticalAlign = f.lengthAttr(s, "val", m.FontSize);
                        break;
                    case "tcW":
                        if (this.options.ignoreWidth) break;
                    case "tblW":
                        t.width = $e.valueOfSize(s, "w");
                        break;
                    case "trHeight":
                        this.parseTrHeight(s, t);
                        break;
                    case "strike":
                        t["text-decoration"] = f.boolAttr(s, "val", !0) ? "line-through" : "none";
                        break;
                    case "b":
                        t["font-weight"] = f.boolAttr(s, "val", !0) ? "bold" : "normal";
                        break;
                    case "i":
                        t["font-style"] = f.boolAttr(s, "val", !0) ? "italic" : "normal";
                        break;
                    case "caps":
                        t["text-transform"] = f.boolAttr(s, "val", !0) ? "uppercase" : "none";
                        break;
                    case "smallCaps":
                        t["font-variant"] = f.boolAttr(s, "val", !0) ? "small-caps" : "none";
                        break;
                    case "u":
                        this.parseUnderline(s, t);
                        break;
                    case "ind":
                    case "tblInd":
                        this.parseIndentation(s, t);
                        break;
                    case "rFonts":
                        this.parseFont(s, t);
                        break;
                    case "tblBorders":
                        ...
                        break;
                    case "tblCellSpacing":
                        t["border-spacing"] = $e.valueOfMargin(s), t["border-collapse"] = "separate";
                        break;
                    case "pBdr":
                        this.parseBorderProperties(s, t);
                        break;
                    case "bdr":
                        t.border = $e.valueOfBorder(s);
                        break;
                    case "tcBorders":
                        this.parseBorderProperties(s, t);
                        break;
                    case "vanish":
                        f.boolAttr(s, "val", !0) && (t.display = "none");
                        break;
                    case "kern":
                    case "noWrap":
                        break;
                    ...
                    case "tcMar":
                        ...
                        break;
                    case "tblLayout":
                        t["table-layout"] = $e.valueOfTblLayout(s);
                        break;
                    case "vAlign":
                        t["vertical-align"] = $e.valueOfTextAlignment(s);
                        break;
                    case "spacing":
                        "pPr" == e.localName && this.parseSpacing(s, t);
                        break;
                    case "wordWrap":
                        f.boolAttr(s, "val") && (t["overflow-wrap"] = "break-word");
                        break;
                    case "suppressAutoHyphens":
                        t.hyphens = f.boolAttr(s, "val", !0) ? "none" : "auto";
                        break;
                    case "lang":
                        t.$lang = f.attr(s, "val");
                        break;
                    case "rtl":
                    case "bidi":
                        f.boolAttr(s, "val", !0) && (t.direction = "rtl");
                        break;
                    case "bCs":
                    case "iCs":
                    case "szCs":
                    ...
                    case "noProof":
                        break;
                    default:
                        this.options.debug && console.warn(`DOCX: Unknown document element: ${e.localName}.${s.localName}`)
                }
            })), t
        }
        parseUnderline(e, t) {
            ...
            if (null != r) {
                ...
                var a = Be.colorAttr(e, "color");
                a && (t["text-decoration-color"] = a)
            }
        }
        parseFont(e, t) {
            var r = [f.attr(e, "ascii"), $e.themeValue(e, "asciiTheme"), f.attr(e, "eastAsia")].filter((e => e)).map((e => a(e)));
            r.length > 0 && (t["font-family"] = [...new Set(r)].join(", "))
        }
        parseIndentation(e, t) {
            var r = f.lengthAttr(e, "firstLine"),
                a = f.lengthAttr(e, "hanging"),
                s = f.lengthAttr(e, "left"),
                n = f.lengthAttr(e, "start"),
                l = f.lengthAttr(e, "right"),
                o = f.lengthAttr(e, "end");
            r && (t["text-indent"] = r), a && (t["text-indent"] = `-${a}`), (s || n) && (t["margin-inline-start"] = s || n), (l || o) && (t["margin-inline-end"] = l || o)
        }
        parseSpacing(e, t) {
            var r = f.lengthAttr(e, "before"),
                a = f.lengthAttr(e, "after"),
                s = f.intAttr(e, "line", null),
                n = f.attr(e, "lineRule");
        ...
        parseMarginProperties(e, t) {
            Be.foreach(e, (e => {
                switch (e.localName) {
                    case "left":
                        t["padding-left"] = $e.valueOfMargin(e);
                        break;
                    case "right":
                        t["padding-right"] = $e.valueOfMargin(e);
                        break;
                    case "top":
                        t["padding-top"] = $e.valueOfMargin(e);
                        break;
                    case "bottom":
                        t["padding-bottom"] = $e.valueOfMargin(e)
                }
            }))
        }
        parseTrHeight(e, t) {
            f.attr(e, "hRule"), t.height = f.lengthAttr(e, "val")
        }
        parseBorderProperties(e, t) {
            Be.foreach(e, (e => {
                switch (e.localName) {
                    case "start":
                    case "left":
                        t["border-left"] = $e.valueOfBorder(e);
                        break;
                    case "end":
                    case "right":
                        t["border-right"] = $e.valueOfBorder(e);
                        break;
                    case "top":
                        t["border-top"] = $e.valueOfBorder(e);
                        break;
                    case "bottom":
                        t["border-bottom"] = $e.valueOfBorder(e)
                }
            }))
        }
    }
    const De = ["black", "blue", "cyan", "darkBlue", "darkCyan", "darkGray", "darkGreen", "darkMagenta", "darkRed", "darkYellow", "green", "lightGray", "magenta", "none", "red", "white", "yellow"];
    class Be {
        static foreach(e, t) {
        ...
        static colorAttr(e, t, r = null, a = "black") {
            var s = f.attr(e, t);
            if (s) return "auto" == s ? a : De.includes(s) ? s : `#${s}`;
            var n = f.attr(e, "themeColor");
            return n ? `var(--docx-${n}-color)` : r
        }
        static sizeValue(e, t = m.Dxa) {
            return u(e.textContent, t)
        }
    }
    class $e {
        ...
        static valueOfSize(e, t) {
            ...
            return f.lengthAttr(e, t, r)
        }
        static valueOfMargin(e) {
            return f.lengthAttr(e, "w")
        }
        static valueOfBorder(e) {
            var t = $e.parseBorderType(f.attr(e, "val"));
            if ("none" == t) return "none";
            var r = Be.colorAttr(e, "color");
            return `${f.lengthAttr(e,"sz",m.Border)} ${t} ${"auto"==r?Me:r}`
        }
        ...
        static valueOfTblLayout(e) {
            return "fixed" == f.attr(e, "val") ? "fixed" : "auto"
        }
        static classNameOfCnfStyle(e) {
            const t = f.attr(e, "val");
        ...
        static classNameOftblLook(e) {
            const t = f.hexAttr(e, "val", 0);
            let r = "";
            return (f.boolAttr(e, "firstRow") || 32 & t) && (r += " first-row"), (f.boolAttr(e, "lastRow") || 64 & t) && (r += " last-row"), (f.boolAttr(e, "firstColumn") || 128 & t) && (r += " first-col"), (f.boolAttr(e, "lastColumn") || 256 & t) && (r += " last-col"), (f.boolAttr(e, "noHBand") || 512 & t) && (r += " no-hband"), (f.boolAttr(e, "noVBand") || 1024 & t) && (r += " no-vband"), r.trim()
        }
    }
    const Fe = {
        pos: 0,
    ...
    function Le(e, t, r, a = .75) {
        const s = e.closest("p"),
            n = e.getBoundingClientRect(),
            l = s.getBoundingClientRect(),
            o = getComputedStyle(s),
            i = t?.length > 0 ? t.map((e => ({
                pos: Ie(e.position),
                leader: e.leader,
                style: e.style
            }))).sort(((e, t) => e.pos - t.pos)) : [Fe],
            c = i[i.length - 1],
            h = l.width * a,
            m = Ie(r);
        let u = c.pos + m;
        if (u < h)
            for (; u < h && i.length < 50; u += m) i.push({
                ...Fe,
                pos: u
            });
    ...
    class _e {
        ...
        async render(e, t, r = null, a) {
            ...
            this.options.inWrapper ? t.appendChild(this.renderWrapper(s)) : Ve(t, s), this.commentHighlight && a.renderComments && CSS.highlights.set(`${this.className}-comments`, this.commentHighlight), this.postRenderTasks.forEach((e => e())), await Promise.allSettled(this.tasks), this.refreshTabStops()
        }
        renderTheme(e, t) {
            const r = {},
            ...
            if (s)
                for (let [e, t] of Object.entries(s.colors)) r[`--docx-${e}-color`] = `#${t}`;
            const n = this.styleToString(`.${this.className}`, r);
            t.appendChild(this.createStyleElement(n))
        }
        renderFontTable(e, t) {
            for (let r of e.fonts)
                for (let e of r.embedFontRefs) this.tasks.push(this.document.loadFont(e.id, e.key).then((s => {
                    const n = {
                        "font-family": a(r.name),
                        src: `url(${s})`
                    };
                    "bold" != e.type && "boldItalic" != e.type || (n["font-weight"] = "bold"), "italic" != e.type && "boldItalic" != e.type || (n["font-style"] = "italic");
                    const l = this.styleToString("@font-face", n);
                    t.appendChild(this.createComment(`docxjs ${r.name} font`)), t.appendChild(this.createStyleElement(l))
                })))
        }
        processStyleName(e) {
            return e ? `${this.className}_${function(e){return e?.replace(/[ .]+/g,"-").replace(/[&]+/g,"and").toLowerCase()}(e)}` : this.className
        }
        processStyles(e) {
            const t = l(e.filter((e => null != e.id)), (e => e.id));
            for (const a of e.filter((e => e.basedOn))) {
                var r = t[a.basedOn];
                if (r) {
                    a.paragraphProps = i(a.paragraphProps, r.paragraphProps), a.runProps = i(a.runProps, r.runProps);
                    for (const e of r.styles) {
                        const t = a.styles.find((t => t.target == e.target));
                        t ? this.copyStyleProperties(e.values, t.values) : a.styles.push({
                            ...e,
                            values: {
                                ...e.values
                            }
        ...
        processElement(e) {
            if (e.children)
                for (var t of e.children) t.parent = e, t.type == N.Table ? this.processTable(t) : this.processElement(t)
        }
        processTable(e) {
            for (var t of e.children)
                for (var r of t.children) r.cssStyle = this.copyStyleProperties(e.cellStyle, r.cssStyle, ["border-left", "border-right", "border-top", "border-bottom", "padding-left", "padding-right", "padding-top", "padding-bottom"]), this.processElement(r)
        }
        ...
        renderSections(e) {
            ...
            for (let r = 0, l = a.length; r < l; r++) {
                ...
                this.options.renderFootnotes && this.renderNotes(this.currentFootnoteIds, this.footnoteMap, i), this.options.renderEndnotes && r == l - 1 && this.renderNotes(this.currentEndnoteIds, this.endnoteMap, i), this.options.renderFooters && this.renderHeaderFooter(o.footerRefs, o, t.length, s != o, i), t.push(i), s = o
            }
            return t
        }
        renderHeaderFooter(e, t, r, a, s) {
            if (e) {
                ...
                if (l) {
                    ...
                    t?.pageMargins && (l.rootElement.type === N.Header ? (e.style.marginTop = `calc(${t.pageMargins.header} - ${t.pageMargins.top})`, e.style.minHeight = `calc(${t.pageMargins.top} - ${t.pageMargins.header})`) : l.rootElement.type === N.Footer && (e.style.marginBottom = `calc(${t.pageMargins.footer} - ${t.pageMargins.bottom})`, e.style.minHeight = `calc(${t.pageMargins.bottom} - ${t.pageMargins.footer})`)), this.currentPart = null
                }
            }
        }
        isPageBreakElement(e) {
            return e.type == N.Break && ("lastRenderedPageBreak" == e.break ? !this.options.ignoreLastRenderedPageBreak : "page" == e.break)
        }
        ...
        splitBySection(e, t) {
            var r = {
                ...
                a = [r];
            for (let t of e) {
                if (t.type == N.Paragraph) {
                    const e = this.findStyle(t.styleName);
                    e?.paragraphProps?.pageBreakBefore && (r.sectProps = s, r.pageBreak = !0, r = {
                        sectProps: null,
                        elements: [],
                        pageBreak: !1
                    }, a.push(r))
                }
                if (r.elements.push(t), t.type == N.Paragraph) {
                    const e = t;
                    var s = e.sectionProps,
                        n = -1,
                        l = -1;
                    if (this.options.breakPages && e.children && (n = e.children.findIndex((e => -1 != (l = e.children?.findIndex(this.isPageBreakElement.bind(this)) ?? -1)))), (s || -1 != n) && (r.sectProps = s, r.pageBreak = -1 != n, r = {
                            sectProps: null,
                            elements: [],
                            pageBreak: !1
                        }, a.push(r)), -1 != n) {
            ...
            for (var s of e) {
                ...
                if (s.bullet) {
                    ...
                    r += this.styleToString(`${n}:before`, {
                        ...
                        background: `var(${e})`
                    }, s.bullet.style), this.tasks.push(this.document.loadNumberingImage(s.bullet.src).then((r => {
                    ...
                    s.level > 0 && (r += this.styleToString(`p.${this.numberingClass(s.id,s.level-1)}`, {
                        "counter-set": t
                    })), a.push(t), r += this.styleToString(`${n}:before`, {
        ...
        renderStyles(e) {
            ...
            const r = this.styleMap,
                a = l(e.filter((e => e.isDefault)), (e => e.target));
            for (const l of e) {
                var s = l.styles;
                if (l.linked) {
                    var n = l.linked && r[l.linked];
                    n ? s = s.concat(n.styles) : this.options.debug && console.warn(`Can't find linked style ${l.linked}`)
                }
                for (const e of s) {
                    var o = `${l.target??""}.${l.cssName}`;
                    l.target != e.target && (o += ` ${e.target}`), a[l.target] == l && (o = `.${this.className} ${l.target}, ` + o), t += this.styleToString(o, e.values)
                }
            }
        ...
        renderElement(e) {
            switch (e.type) {
                ...
                case N.EndnoteReference:
                    return this.renderEndnoteReference(e);
                case N.NoBreakHyphen:
                ...
                case N.MmlMath:
                    return this.renderContainerNS(e, He, "math", {
                        xmlns: He
                    });
                case N.MmlMathParagraph:
                    return this.renderContainer(e, "span");
                case N.MmlFraction:
                    return this.renderContainerNS(e, He, "mfrac");
                case N.MmlBase:
                    return this.renderContainerNS(e, He, e.parent.type == N.MmlMatrixRow ? "mtd" : "mrow");
                case N.MmlNumerator:
                case N.MmlDenominator:
                case N.MmlFunction:
                case N.MmlLimit:
                case N.MmlBox:
                    return this.renderContainerNS(e, He, "mrow");
                case N.MmlGroupChar:
                    return this.renderMmlGroupChar(e);
                case N.MmlLimitLower:
                    return this.renderContainerNS(e, He, "munder");
                case N.MmlMatrix:
                    return this.renderContainerNS(e, He, "mtable");
                case N.MmlMatrixRow:
                    return this.renderContainerNS(e, He, "mtr");
                case N.MmlRadical:
                    return this.renderMmlRadical(e);
                case N.MmlSuperscript:
                    return this.renderContainerNS(e, He, "msup");
                case N.MmlSubscript:
                    return this.renderContainerNS(e, He, "msub");
                case N.MmlDegree:
                case N.MmlSuperArgument:
                case N.MmlSubArgument:
                    return this.renderContainerNS(e, He, "mn");
                case N.MmlFunctionName:
                    return this.renderContainerNS(e, He, "ms");
                case N.MmlDelimiter:
        ...
        renderContainer(e, t, r) {
            return this.createElement(t, r, this.renderElements(e.children))
        }
        renderContainerNS(e, t, r, a) {
            return this.createElementNS(t, r, a, this.renderElements(e.children))
        }
        renderParagraph(e) {
            var t = this.renderContainer(e, "p");
            const r = this.findStyle(e.styleName);
            e.tabs ?? (e.tabs = r?.paragraphProps?.tabs), this.renderClass(e, t), this.renderStyleValues(e.cssStyle, t), this.renderCommonProperties(t.style, e);
        ...
        renderHyperlink(e) {
            ...
            let r = "";
            if (e.id) {
                const t = this.document.documentPart.rels.find((t => t.id == e.id && "External" === t.targetMode));
                r = t?.target ?? r
            }
        ...
        renderCommentContent(e, t) {
            t.appendChild(this.createElement("div", {
                className: `${this.className}-comment-author`
            }, [e.author])), t.appendChild(this.createElement("div", {
                className: `${this.className}-comment-date`
            }, [new Date(e.date).toLocaleString()])), this.renderElements(e.children, t)
        }
        renderDrawing(e) {
        ...
        renderImage(e) {
            ...
            return this.renderStyleValues(e.cssStyle, t), this.document && this.tasks.push(this.document.loadDocumentImage(e.src, this.currentPart).then((e => {
                t.src = e
            }))), t
        }
        renderText(e) {
        ...
        renderRun(e) {
            ...
            if (e.id && (t.id = e.id), this.renderClass(e, t), this.renderStyleValues(e.cssStyle, t), e.verticalAlign) {
                ...
                this.renderElements(e.children, r), t.appendChild(r)
        ...
        renderVmlElement(e) {
            ...
            return e.imageHref?.id && this.tasks.push(this.document?.loadDocumentImage(e.imageHref.id, this.currentPart).then((e => r.setAttribute("href", e)))), t.appendChild(r), requestAnimationFrame((() => {
        ...
        renderVmlChildElement(e) {
            ...
            for (let r of e.children) r.type == N.VmlElement ? t.appendChild(this.renderVmlChildElement(r)) : t.appendChild(...c(this.renderElement(r)));
            return t
        }
        renderMmlRadical(e) {
            const t = e.children.find((e => e.type == N.MmlBase));
            if (e.props?.hideDegree) return this.createElementNS(He, "msqrt", null, this.renderElements([t]));
            const r = e.children.find((e => e.type == N.MmlDegree));
            return this.createElementNS(He, "mroot", null, this.renderElements([t, r]))
        }
        renderMmlDelimiter(e) {
            const t = [];
            return t.push(this.createElementNS(He, "mo", null, [e.props.beginChar ?? "("])), t.push(...this.renderElements(e.children)), t.push(this.createElementNS(He, "mo", null, [e.props.endChar ?? ")"])), this.createElementNS(He, "mrow", null, t)
        }
        renderMmlNary(e) {
            const t = [],
                r = l(e.children, (e => e.type)),
                a = r[N.MmlSuperArgument],
                s = r[N.MmlSubArgument],
                n = a ? this.createElementNS(He, "mo", null, c(this.renderElement(a))) : null,
                o = s ? this.createElementNS(He, "mo", null, c(this.renderElement(s))) : null,
                i = this.createElementNS(He, "mo", null, [e.props?.char ?? "∫"]);
            return n || o ? t.push(this.createElementNS(He, "munderover", null, [i, o, n])) : n ? t.push(this.createElementNS(He, "mover", null, [i, n])) : o ? t.push(this.createElementNS(He, "munder", null, [i, o])) : t.push(i), t.push(...this.renderElements(r[N.MmlBase].children)), this.createElementNS(He, "mrow", null, t)
        }
        renderMmlPreSubSuper(e) {
            const t = [],
                ...
                n = a ? this.createElementNS(He, "mo", null, c(this.renderElement(a))) : null,
                o = s ? this.createElementNS(He, "mo", null, c(this.renderElement(s))) : null,
                i = this.createElementNS(He, "mo", null);
            return t.push(this.createElementNS(He, "msubsup", null, [i, o, n])), t.push(...this.renderElements(r[N.MmlBase].children)), this.createElementNS(He, "mrow", null, t)
        }
        renderMmlGroupChar(e) {
            const t = "bot" === e.props.verticalJustification ? "mover" : "munder",
                r = this.renderContainerNS(e, He, t);
            return e.props.char && r.appendChild(this.createElementNS(He, "mo", null, [e.props.char])), r
        }
        renderMmlBar(e) {
            const t = this.renderContainerNS(e, He, "mrow");
        ...
        renderMmlRun(e) {
            const t = this.createElementNS(He, "ms", null, this.renderElements(e.children));
            return this.renderClass(e, t), this.renderStyleValues(e.cssStyle, t), t
        }
        renderMllList(e) {
            const t = this.createElementNS(He, "mtable");
            this.renderClass(e, t), this.renderStyleValues(e.cssStyle, t);
            for (let r of this.renderElements(e.children)) t.appendChild(this.createElementNS(He, "mtr", null, [this.createElementNS(He, "mtd", null, [r])]));
            return t
        }
        ...
        levelTextToContent(e, t, r, a) {
            return `"${e.replace(/%\d*/g,(e=>{let t=parseInt(e.substring(1),10)-1;return`"counter(${this.numberingCounter(r,t)}, ${a})"`}))}${{tab:"\\9",space:"\\a0"}[t]??""}"`
        }
        ...
        refreshTabStops() {
            this.options.experimental && setTimeout((() => {
                ...
                for (let t of this.currentTabs) Le(t.span, t.stops, this.defaultTabSize, e)
            }), 500)
        }
        createElementNS(e, t, r, a) {
            var s = e ? this.htmlDocument.createElementNS(e, t) : this.htmlDocument.createElement(t);
            return Object.assign(s, r), a && Ve(s, a), s
        }
        createElement(e, t, r) {
            return this.createElementNS(void 0, e, t, r)
        }
        createSvgElement(e, t, r) {
            return this.createElementNS(Oe, e, t, r)
        }
    ...
    async function Xe(e, t, r, a) {
        const s = {
            ...
            n = new _e(window.document);
        return await n.render(e, t, r, s)
    }
    e.defaultOptions = je, e.parseAsync = We, e.renderAsync = async function(e, t, r, a) {
        const s = await We(e, a);
        return await Xe(s, t, r, a), s
    }, e.renderDocument = Xe
}));
